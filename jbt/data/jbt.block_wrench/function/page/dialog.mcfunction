    ...
    { \
      ...
      "contents": [{ \
            "translate":"jbt.book.page_template","font":"jbt:base","shadow_color":0,"color":"white","with":[ \
                {"translate":"item.jbt.block_wrench","color":"#f8f4ed","font":"minecraft:default"}, \
                ...
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.blank_row_3"}]}, \
                {"translate":"jbt.book.block_wrench_diagram"}, \
                {"translate":"jbt.book.block_wrench_description","color":"#4469a4","font":"minecraft:default"}, \
