    ...
    { \
      ...
      "contents": [{ \
            "translate":"jbt.book.page_template","font":"jbt:base","shadow_color":0,"color":"white","with":[ \
                {"translate":"item.jbt.void_bucket","color":"#f8f4ed","font":"minecraft:default"}, \
                ...
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.bucket_row_2"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.bucket"}}}, \
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.blank_row_2"}]}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.blank_row_3"}]}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.blank_row_3"}]}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.blank_row_3"}]}, \
                {"translate":"jbt.book.void_bucket_diagram"}, \
                {"translate":"jbt.book.void_bucket_description","color":"#4469a4","font":"minecraft:default"}, \
