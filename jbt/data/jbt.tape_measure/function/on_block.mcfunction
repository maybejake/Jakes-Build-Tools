...
execute if predicate jbt.tape_measure:open/either run return run function jbt.tape_measure:action/measure/check
execute if predicate jbt.tape_measure:either run return run function jbt.tape_measure:action/store/check