data remove storage jbt:temp loot_table.output
...
data modify storage jbt:temp loot_table.output set from entity 4527932a-f84b-4094-9141-3206d29dba22 item
