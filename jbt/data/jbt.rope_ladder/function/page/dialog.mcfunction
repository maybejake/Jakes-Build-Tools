    ...
    { \
      ...
      "contents": [{ \
            "translate":"jbt.book.page_template","font":"jbt:base","shadow_color":0,"color":"white","with":[ \
                {"translate":"item.jbt.rope_ladder","color":"#f8f4ed","font":"minecraft:default"}, \
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.blank_row_1"}]}, \
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.ladder_row_1"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.ladder"}}}, \
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.blank_row_1"}]}, \
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.blank_row_2"}]}, \
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.string_row_2"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.string"}}}, \
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.blank_row_2"}]}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.blank_row_3"}]}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.ladder_row_3"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.ladder"}}}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.blank_row_3"}]}, \
                {"translate":"jbt.book.rope_ladder_diagram"}, \
                {"translate":"jbt.book.rope_ladder_description","color":"#4469a4","font":"minecraft:default"}, \
