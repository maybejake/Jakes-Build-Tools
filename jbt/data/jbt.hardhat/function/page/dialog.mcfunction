    ...
    { \
      ...
      "contents": [{ \
            "translate":"jbt.book.page_template","font":"jbt:base","shadow_color":0,"color":"white","with":[ \
                {"translate":"item.jbt.hardhat","color":"#f8f4ed","font":"minecraft:default"}, \
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.gold_ingot_row_1"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.gold_ingot"}}}, \
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.gold_ingot_row_1"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.gold_ingot"}}}, \
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.gold_ingot_row_1"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.gold_ingot"}}}, \
                ...
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.leather_row_3"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.leather"}}}, \
                {"translate":"jbt.book.hardhat_diagram"}, \
                {"translate":"jbt.book.hardhat_description","color":"#4469a4","font":"minecraft:default"}, \
