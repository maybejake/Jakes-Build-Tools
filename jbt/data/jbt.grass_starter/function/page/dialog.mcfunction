    ...
    { \
      ...
      "contents": [{ \
            "translate":"jbt.book.page_template","font":"jbt:base","shadow_color":0,"color":"white","with":[ \
                {"translate":"item.jbt.grass_starter","color":"#f8f4ed","font":"minecraft:default"}, \
                ...
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.leather_row_1"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.leather"}}}, \
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.string_row_1"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.string"}}}, \
                ...
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.short_grass_row_2"}],"hover_event":{"action":"show_text","value":{"translate":"block.minecraft.short_grass"}}}, \
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.leather_row_2"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.leather"}}}, \
                ...
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.leather_row_3"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.leather"}}}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.leather_row_3"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.leather"}}}, \
                {"translate":"jbt.book.grass_starter_diagram"}, \
                {"translate":"jbt.book.grass_starter_description","color":"#4469a4","font":"minecraft:default"}, \
