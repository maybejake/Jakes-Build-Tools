...
execute if block ~ ~ ~ minecraft:lava_cauldron run playsound minecraft:item.bucket.fill_lava neutral @a ~ ~ ~ 1 1
execute if block ~ ~ ~ minecraft:lava_cauldron run return run setblock ~ ~ ~ minecraft:cauldron replace

execute if block ~ ~ ~ minecraft:water_cauldron run playsound minecraft:item.bucket.fill neutral @a ~ ~ ~ 1 1
execute if block ~ ~ ~ minecraft:water_cauldron run return run setblock ~ ~ ~ minecraft:cauldron replace

execute if block ~ ~ ~ minecraft:powder_snow_cauldron run playsound minecraft:item.bucket.fill_powder_snow neutral @a ~ ~ ~ 1 1
