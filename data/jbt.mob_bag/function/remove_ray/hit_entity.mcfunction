...
execute as @p[tag=jbt_bag_ray] run function jbt.mob_bag:remove_ray/modify with storage jbt:temp bag

execute unless data entity @s CustomName run function jbt.mob_bag:remove_ray/no_name
