execute if entity @s[predicate=jbt.main:unbreaking/mainhand/all] if function jbt.trowel:durability/mainhand/unbreaking run return run function jbt.trowel:durability/modify

#handle damage
data modify storage jbt:temp trowel.components set from entity @s SelectedItem.components
...
function jbt.trowel:durability/mainhand/apply with storage jbt:temp trowel
execute if score $damage jbt.dummy >= $max_damage jbt.dummy run function jbt.trowel:durability/mainhand/break