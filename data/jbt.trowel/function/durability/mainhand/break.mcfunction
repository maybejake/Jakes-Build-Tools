...
execute if entity @s[predicate=jbt.trowel:mainhand/diamond] if entity @s[predicate=jbt.main:unbreaking/mainhand/3] run advancement grant @s only jbt.trowel:visible/break_trowel
