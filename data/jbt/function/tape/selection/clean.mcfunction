...
execute if entity @s[tag=jbt_tape_offhand] store result score jbt score_storage run data get entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".jbt_tape_id
