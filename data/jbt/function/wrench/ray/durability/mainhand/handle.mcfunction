...
execute if entity @s[predicate=jbt:unbreaking/mainhand/all] run function jbt:wrench/ray/durability/mainhand/unbreaking
execute if score @s jbt_wrench_unbreaking_check matches 1 run return fail

#handle damage
data modify storage jbt:wrench components set from entity @s SelectedItem.components
...
function jbt:wrench/ray/durability/mainhand/apply with storage jbt:wrench
execute if score @s jbt_wrench_damage >= @s jbt_wrench_max_damage run function jbt:wrench/ray/durability/mainhand/break