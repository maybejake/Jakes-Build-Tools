...
execute if entity @s[predicate=jbt:bag/offhand] run item modify entity @s weapon.offhand [{"function":"minecraft:set_components","components":{"minecraft:item_model":"jbt:mob_bag_empty"}},{"function":"minecraft:set_custom_data","tag":"{jbt_filled:0b,jbt_id:-1}"},{"function": "minecraft:set_lore","entity":"this","lore":[],"mode":"replace_all"}]