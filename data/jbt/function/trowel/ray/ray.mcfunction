execute if block ~ ~ ~ #jbt:blocks unless block ^ ^ ^0.05 #jbt:blocks unless entity @e[type=!#jbt:raybanned,distance=..1,sort=nearest,limit=1] run function jbt:trowel/ray/hit
