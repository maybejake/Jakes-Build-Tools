...
execute if predicate jbt.tape_measure:open/offhand at @s run function jbt.tape_measure:sounds/in
execute unless predicate jbt.tape_measure:open/offhand at @s run playsound minecraft:item.spyglass.use neutral @a ~ ~ ~ 1 1
