    ...
    { \
      ...
      "contents": [{ \
            "translate":"jbt.book.page_template","font":"jbt:base","shadow_color":0,"color":"white","with":[ \
                {"translate":"item.jbt.tape_measure","color":"#f8f4ed","font":"minecraft:default"}, \
                ...
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.iron_ingot_row_1"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.iron_ingot"}}}, \
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.light_weighted_pressure_plate_row_2"}],"hover_event":{"action":"show_text","value":{"translate":"block.minecraft.light_weighted_pressure_plate"}}}, \
                ...
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.gold_ingot_row_2"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.gold_ingot"}}}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.blank_row_3"}]}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.blank_row_3"}]}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.blank_row_3"}]}, \
                {"translate":"jbt.book.tape_measure_diagram"}, \
                {"translate":"jbt.book.tape_measure_description","color":"#4469a4","font":"minecraft:default"}, \
