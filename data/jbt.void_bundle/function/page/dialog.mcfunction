    ...
    { \
      ...
      "contents": [{ \
            "translate":"jbt.book.page_template","font":"jbt:base","shadow_color":0,"color":"white","with":[ \
                {"translate":"item.jbt.void_bundle","color":"#f8f4ed","font":"minecraft:default"}, \
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.blank_row_1"}]}, \
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.ender_eye_row_1"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.ender_eye"}}}, \
                {"translate":"jbt.book.item_slot_row_1","with":[{"translate":"jbt.book.blank_row_1"}]}, \
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.bone_row_2"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.bone"}}}, \
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.bundle_row_2"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.bundle"}}}, \
                {"translate":"jbt.book.item_slot_row_2","with":[{"translate":"jbt.book.bone_row_2"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.bone"}}}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.blank_row_3"}]}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.bone_row_3"}],"hover_event":{"action":"show_text","value":{"translate":"item.minecraft.bone"}}}, \
                {"translate":"jbt.book.item_slot_row_3","with":[{"translate":"jbt.book.blank_row_3"}]}, \
                {"translate":"jbt.book.void_bundle_diagram"}, \
                {"translate":"jbt.book.void_bundle_description","color":"#4469a4","font":"minecraft:default"}, \
