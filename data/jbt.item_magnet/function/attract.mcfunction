...
execute positioned ~ ~-0.5 ~ facing entity @a[tag=jbt.has_magnet,sort=nearest,limit=1] feet positioned 0.0 0.0 0.0 positioned ^ ^ ^0.3 summon minecraft:area_effect_cloud run function jbt.item_magnet:cloud
